...
import static mx.examen_3.MovieContract.MovieEntry.TABLE_NAME;
...
public class MovieDBAdapter {
    ...
    public long insertMovie(Movie movie) throws SQLException {
        ...
        long id= sqLiteDatabase.insertOrThrow(TABLE_NAME, null,
                contentValues);
        return id;
    }
    ...
    public ArrayList<Movie> getMovies(){
        ...
        String[] columns = {
                ...
                MovieEntry.PRICE,
                MovieEntry.IMAGE };
        Cursor cursor = sqLiteDatabase.query(TABLE_NAME, columns,null,
                null,null,null,null);
    ...
    public Movie searchById(long id){
        ...
        String query = "SELECT * FROM " +TABLE_NAME+ " WHERE id IS " + id;
        Cursor cursor = sqLiteDatabase.query(TABLE_NAME, columns,null,
                null,null,null,null);
        cursor.moveToNext();
        movie.setId(cursor.getLong(cursor.getColumnIndex(MovieEntry.ID)));
    ...
    public long updateMovie(Movie movie) throws SQLException {
        ...
        long id= sqLiteDatabase.update(TABLE_NAME, contentValues,MovieEntry.ID + " = " +movie.getId(), null);
        return id;
    }
